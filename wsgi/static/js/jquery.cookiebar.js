...
(function($){
	$.cookieBar = function(options,val){
		...
		var defaults = {
			message: 'Esta web utiliza cookies para mejorar la experiencia del usuario.<a href="/aviso-de-cookies" title="Sobre el uso de cookies">M&aacutes informaci&oacuten</a>', //Message displayed on bar
			...
			policyURL: '/aviso-de-cookies/', //URL of Privacy Policy
