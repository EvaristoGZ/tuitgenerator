...
<!--[if gt IE 8]><!--> <html class="no-js" lang="es"> <!--<![endif]-->
	...
	<div class="container">
		<div class="estatica">
			...
			<p>Más tarde, la Ley se reformó: los usuarios debían de ser informados pero no era necesario el consentimiento explícito. Ahora, si un usuario continúa navegando por nuestro sitio web se considera que acepta su uso.</p>
			...
			<p>Puede permitir, conocer, bloquear o eliminar las cookies instaladas en tu equipo mediante la configuración de las opciones del navegador web que utiliza. Puede encontrar información sobre cómo hacerlo en los sitios web de los principales navegadores</p>
			<ul>
