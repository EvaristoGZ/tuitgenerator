	...
	<div class="container">
	  <div class="row">
		<div class="col-md-4">
		  ...
		  <div id="code"><code>&lt;a href="{{link or 'Dirección URL'}}" title="Click para retuitear." target="_blank" style="background:url('https://si0.twimg.com/images/dev/cms/intents/icons/retweet_on.png') no-repeat left center; padding:1px 0 1px 18px; line-height:19px; color:#00A7FF"&gt;{{texto or 'Texto a enlazar'}}&lt;/a&gt;</code></div>
		</div>
		<div class="col-md-4">
		<h2>Ejemplo de integración</h2>
		  ...
		  <p><a href="https://twitter.com/intent/retweet?tweet_id=440808384619905025&related=EvaristoGZ,tuitgenerator" title="Click para retuitear." target="_blank" class="retuit-1">Googlea tu nombre, el 80% de los entrevistadores lo hacen antes de concederte una entrevista de trabajo.</a></p>
