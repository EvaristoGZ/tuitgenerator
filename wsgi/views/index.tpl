	...
	<div class="jumbotron">
	  <div class="container">
		<h1>Hello, world!</h1>
			...
			<div class="col-md-6">
				<input class="form-control input-lg" name="hashtags" id="hashtags" type="text" pattern="^[A-Za-z0-9_,]{1,40}$" title="No debe incluir #. En caso de ser varios sepárelos por comas sin espacios." placeholder="Hashtags: Python,Bottle">
			</div>
			<div class="col-md-4">
	...
	<div class="container">
	  <div class="row">
		<div class="col-md-4">
		  ...
		  <div id="code"><code>&lt;a href="{{link}}" title="Click para tuitear este texto." target="_blank" style="background:url('https://dev.twitter.com/sites/default/files/images_documentation/bird_blue_16.png') no-repeat left center; padding:1px 0 1px 16px; line-height:19px; color:rgba(0,172,238,1)"&gt;{{texto}}&lt;/a&gt;</code></div>
		</div>
		<div class="col-md-4">
